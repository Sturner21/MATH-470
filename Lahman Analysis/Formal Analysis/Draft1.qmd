...
\\
logit(\frac{\pi_{nip}}{1-\pi_{nip}})&=\beta_{n1}\cdot Age_{ni}+\beta_{n2}\cdot(Age_{ni})^2+\beta_{n3}\cdot(Age_{ni})^3+\beta_{n4}\cdot(Age_{ni})^4+\alpha_n+\delta_i
+\xi_p
\end{align}
$$
...
\log(\pi_{nip}) &= \alpha_{n}+\beta_n\cdot (Age_{ni}-30)+\eta_n\cdot (Age_{ni}-30)^2+\delta_p+\xi_i
\end{align}
$$
