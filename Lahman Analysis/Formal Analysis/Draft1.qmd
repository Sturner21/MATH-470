...
ggplot(data = i582.Trajectory)+
  ...
  geom_smooth()+
  scale_y_continuous(labels = label_percent())+
  labs(title = "Actual Trajectory for player #582")
```
...
ggplot(data = i582.Trajectory)+
  ...
  geom_smooth(color="red")+
  scale_y_continuous(labels = label_percent())+
  labs(title = "Predicted Career Trajectory for #582")
```
...
ggplot(data = i177.Trajectory)+
  ...
  geom_smooth()+
  scale_y_continuous(labels = label_percent())+
  labs(title = "Actual Trajectory for player #177")
```
...
ggplot(data = i177.Trajectory)+
  ...
  geom_smooth(color="red")+
  scale_y_continuous(labels = label_percent())+
  labs(title = "Predicted Career Trajectory for #177")
```
...
ggplot(data = i420.Trajectory)+
  ...
  geom_smooth()+
  scale_y_continuous(labels = label_percent())+
  labs(title = "Actual Trajectory for player #420")
```
...
ggplot(data = i420.Trajectory)+
  ...
  geom_smooth(color="red")+
  scale_y_continuous(labels = label_percent())+
  labs(title = "Predicted Career Trajectory for #420")
```
