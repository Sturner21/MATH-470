...
model {
  for (n in 1:N){
    HR[n] ~ binomial_logit(AB[n], alpha[Player[n]] + beta1[Player[n]]*cAge[n] + beta2[Player[n]]*cAgeSq[n] + beta3[Player[n]]*cAgeCb[n] + beta4[Player[n]]*cAgeQa[n] + beta5[Park[n]]);
  }
  ...
  mu3 ~ normal(0, 0.01);
  sigma3 ~ exponential(1000);
  mu4 ~ normal(0, 0.01);
  sigma4 ~ exponential(10000);
